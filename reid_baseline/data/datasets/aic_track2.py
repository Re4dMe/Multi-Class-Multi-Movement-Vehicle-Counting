...
class aic_track2(BaseImageDataset):
    ...
    def __init__(self, cfg, root='data', verbose=True, **kwargs):
    ...
    def _process_test(self):
        gallery_imgs = []
        #test_dir = 'Z://dataset//aic19//mtmc-vt-master//mtmc-vt-master//src//aic19-track1-mtmc//adjust_c_cropped_imgs2020//c006'
        
        test_dir = self.cfg.DATASETS.DATA_PATH
